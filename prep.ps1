...
iwr -Uri "https://raw.githubusercontent.com/psreed/workshop-control-repo/production/workshop_key.enc" -OutFile ~/workshop_key.enc
...
git clone -q https://www.github.com/psreed/workshop-control-repo.git

echo "Reconfiguring Workshop Control Repo to sync via SSH..."
cd workshop-control-repo
"$(& git remote remove origin 2>&1)"
"$(& git remote add origin git@github.com:psreed/workshop-control-repo 2>&1)"
