...
curl "https://raw.githubusercontent.com/psreed/workshop-control-repo/production/workshop_key.enc" -L -o ~/workshop_key.enc
...
git remote add origin git@github.com:psreed/workshop-control-repo
